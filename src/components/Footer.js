  ...
  return (
    <footer className="sticky-bottom">
      <div className="d-flex justify-content-center pt-3">
        ...
        <a className="px-4" href="https://www.instagram.com/">
          <iconify-icon icon="mdi:instagram" width="50"></iconify-icon>
        </a>
        <a className="px-4" href="https://github.com/">
          <iconify-icon icon="mdi:github" width="50"></iconify-icon>
        </a>
        <a className="px-4" href="https://wa.me/+2349157284517">
          <iconify-icon icon="logos:whatsapp-icon" width="50"></iconify-icon>
        </a>
        <a className="px-4" href="https://twitter.com/">
